...
type Day = { dateKey: string; meals: Meal[]; hasWorkout: boolean; weightKg: number | null };
...
export function HistoryDayList({ days, targets, todayKey }: { days: Day[]; targets: MealTotals; todayKey: string }) {
